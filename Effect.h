...
private:
    ...
    void lowpassTick(float& sample, float cutoff, float q, float morph, float gain, int v);
    void highpassTick(float& sample, float cutoff, float q, float morph, float param4, float param5, int v);
    void bandpassTick(float& sample, float cutoff, float q, float morph, float param4, float param5, int v);
    void diodeLowpassTick(float& sample, float cutoff, float q, float morph, float param4, float param5, int v);
    void LadderLowpassTick(float& sample, float cutoff, float q, float morph, float param4, float param5, int v);
    void VZlowshelfTick(float& sample, float cutoff, float q, float morph, float param4, float param5, int v);
    void VZhighshelfTick(float& sample, float cutoff, float q, float morph, float param4, float param5, int v);
    void VZpeakTick(float& sample, float cutoff, float q, float morph, float param4, float param5, int v);
    void VZbandrejectTick(float& sample, float cutoff, float q, float morph, float param4, float param5, int v);
